...
> **关联**：[引擎对接与 Mock 模式方案](../03-落地方案/引擎对接与Mock模式方案.md) · [Mock fixture 说明](../../../../../project_backend/svmp/open-api-service/src/main/resources/mock/engine/README.md) · [运营 UI](../../../../../project_frontend/asset/asset-openplatform-manage/src/views/openPlatform/MockManualIngest.vue)
