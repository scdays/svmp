# -*- coding: utf-8 -*-
"""Regenerate vuln-task-center PRD with AH vendor (UTF-8)."""
from pathlib import Path

OUT = Path(__file__).parent / "vuln-task-center-扫描治理中心-PRD.md"

SECTION_43 = Path(__file__).parent / "_ah_section_43.md"
# fix typo in section file for reconcile line
section_43 = SECTION_43.read_text(encoding="utf-8").replace(
...
PRD = """# vuln-task-center 扫描治理中心 — 产品需求文档（PRD）
...
OUT.write_text(PRD, encoding="utf-8")
assert "安恒明鉴" in PRD and "ScannerAdapter-AH" in PRD
print("OK", OUT, len(PRD))
