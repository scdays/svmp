...
| [multi-agent-执行Prompts.md](../open-platform-开放平台/07-multi-agent执行Prompts/multi-agent-执行Prompts.md) | 生成的 Agent Prompt（执行用） |
| [开放平台集成管理-完整落地方案.md](../open-platform-开放平台/03-落地方案/开放平台集成管理-完整落地方案.md) | 业务落地方案 |
