...
| **Mock 可切换** | `open-api.engine.adapter-mode=mock` 时走 fixture，**Partner 无感知**；见 [引擎对接与Mock模式方案](../../mock-引擎对接与联调/03-落地方案/引擎对接与Mock模式方案.md) |
...
| 文档 | [引擎对接与Mock模式方案.md](../../mock-引擎对接与联调/03-落地方案/引擎对接与Mock模式方案.md) | 本节 §3 |
